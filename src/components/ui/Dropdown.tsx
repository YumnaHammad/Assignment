...
export const Dropdown: React.FC<DropdownProps> = ({ trigger, children, className }) => {
  ...
  return (
    <div className={cn("relative inline-block text-left", className)} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-md bg-popover text-popover-foreground shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
...
export const DropdownSeparator: React.FC = () => <div className="my-1 h-px bg-muted" />;
